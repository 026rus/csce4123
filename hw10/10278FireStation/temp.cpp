 ...
 *
 *        Version:  1.0
 *        Created:  11/06/2016 11:00:59 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
int main(void)
{
    ...
    int cost, min_cost, best_place_to_build_the_goddamn_station =0 ;
    ...
    while(test_cases--) {
        ...
        std::cout << firestations << " _ " << intersections << std::endl;
        ...
        std::cout << "Test case: " << test_cases << std::endl;
